...
> = {
  ...
  AL: {
    ...
    laws: {
      Promulgada: [
        {
          title: "LEI Nº 9.095, DE 11 DE DEZEMBRO DE 2023",
          summary: `Estabelece princípios e diretrizes para o uso responsável da 
  ...
  AM: {
    ...
    laws: {
      Proposta: [
        {
          title: "PROJETO DE LEI Nº 940/2024, DE 12 DE DEZEMBRO DE 2024",
          summary: `Busca regulamentar o uso da Inteligência Artificial no Estado do Amazonas, 
        ...
        {
          title: "PROJETO DE LEI Nº 621/2025, DE 23 DE JUNHO DE 2025",
          summary: `Proíbe a utilização de sistemas de inteligênciaartificial (IA) como substituto 
  ...
  BA: {
    ...
    laws: {
      Proposta: [
        {
          title: "PROJETO DE LEI Nº 25725/2025, 01 DE ABRIL DE 2025",
          summary: `Propõe a inclusão da disciplina eletiva de Inteligência Artificial na grade educacional 
  ...
  CE: {
    ...
    laws: {
      Proposta: [
        {
          title: "PROJETO DE LEI Nº 612/2025, DE 07 DE JULHO DE 2025",
          summary: `DISPÕE SOBRE A POLÍTICA ESTADUAL DE FOMENTO À INOVAÇÃO EM INTELIGÊNCIA ARTIFICIAL NO ESTADO DO CEARÁ.`,
          link: "https://www2.al.ce.gov.br/legislativo/tramit2025/pl612_25.pdf",
        },
      ],
      Promulgada: [
        {
          title: "LEI Nº 17.611, DE 11 DE AGOSTO DE 2021",
          summary: `Estabelece princípios, direitos e deveres para o uso de Inteligência Artificial no estado, com foco 
  ...
  ES: {
    ...
    laws: {
      Proposta: [
        {
          title: "PROJETO DE LEI Nº 390/2025, 12 DE JUNHO DE 2025",
          summary: `Dispõe sobre a proibição da veiculação de publicidade de serviços de prevenção, cuidado e tratamento de 
  ...
  GO: {
    ...
    laws: {
      Promulgada: [
        {
          title: "LEI COMPLEMENTAR Nº 205, DE 19 DE MAIO DE 2025",
          summary: `Institui a Política Estadual de Fomento à Inovação em Inteligência Artificial, 
  ...
  MG: {
    ...
    laws: {
      Proposta: [
        {
          title: "PROJETO DE LEI Nº 3.634/2025, DE 10 DE ABRIL DE 2025",
          summary: `Dispõe sobre a inclusão obrigatória de conteúdos relacionados à Inteligência Artificial
        ...
        {
          title: "PROJETO DE LEI Nº 4.097/2025, DE 18 DE JULHO DE 2025",
          summary: `Institui o Programa Mineiro de Educação Digital, Segurança Cibernética e Inteligência Artificial
        ...
        {
          title: "PROJETO DE LEI Nº 4.220/2025, DE 13 DE AGOSTO DE 2025",
          summary: `Institui a política de inovação logística no agronegócio por meio da inteligência artificial no 
  ...
  PB: {
    ...
    laws: {
      Proposta: [
        {
          title: "PROJETO DE LEI Nº 2.586/2024, DE 15 DE ABRIL DE 2025",
          summary: `Institui a aprendizagem do uso ético da Inteligência Artificial (IA) nas escolas da rede pública 
  ...
  PR: {
    ...
    laws: {
      Proposta: [
        {
          title: "PROJETO DE LEI Nº 175/2025, DE 31 DE MARÇO DE 2025",
          summary: `Permite que o Governo do Paraná firme parcerias com entidades públicas e privadas para aliar 
      ...
      Promulgada: [
        {
          title: "LEI Nº 22.324, DE 2 DE ABRIL DE 2025",
          summary: `Institui o Plano de Diretrizes de Inteligência Artificial na Administração Pública 
          ...
          -de-inteligencia-artificial-na-administracao-publica-estadual-e-altera-as-laws-que-especifica`,
        },
        {
          title: "LEI Nº 22.343, DE 4 DE ABRIL DE 2025",
          summary: `Regula o uso da Inteligência Artificial no Estado do Paraná, estabelecendo princípios éticos, transparência, 
      ...
      Proposta: [
        {
          ...
          summary: `Ação pioneira voltada para a implementação responsável da IA na educação e na divulgação científica, 
        ...
        {
          title: "PROJETO DE LEI Nº 4669/2025, DE 04 DE FEVEREIRO DE 2025",
          summary: `Dispõe sobre a política de fomento ao desenvolvimento e aplicação de soluções baseada em IA no 
  ...
  RS: {
    ...
    laws: {
      Proposta: [
        {
          title: "PROJETO DE LEI Nº 179/2025",
          summary: `Institui a Política Estadual de Fomento àInovação em Inteligência Artificial no Estadodo Rio Grande do Sul.`,
  ...
  RO: {
    ...
    laws: {
      Proposta: [
        {
          title: "PROJETO DE LEI ORDINÁRIA N° 392/2024, DE 05 DE MARÇO DE 2024",
          summary: `Propõe a regulamentação do uso de Inteligência Artificial na administração pública estadual, com 
  ...
  SC: {
    ...
    laws: {
      Promulgada: [
        {
          title: "LEI Nº 19.450, DE 5 DE SETEMBRO DE 2025",
          summary: `Dispõe sobre os princípios e diretrizes para o uso da Inteligência Artificial 
  ...
  SP: {
    ...
    laws: {
      Proposta: [
        {
          title: "PROJETO DE LEI Nº 572/2025, DE 06 DE JUNHO DE 2025",
          summary: `Dispõe sobre a obrigatoriedade de Informações dos serviços de mídias 
          digitais, ou não, criadas por Inteligência Artificial (IA).`,
          link: "https://www.al.sp.gov.br/propositura/?id=1000611758",
        },
        {
          title: "PROJETO DE LEI Nº 323/2025, DE 11 DE ABRIL DE 2025",
          summary: `Dispõe sobre o uso de recursos de inteligência artificial na educação básica da rede pública estadual.`,
  ...
  TO: {
    ...
    laws: {
      Promulgada: [
        {
          title: "LEI Nº 4.752, DE 27 DE JUNHO DE 2025.",
          summary: `Inclui a disciplina eletiva de Inteligência Artificial como um dos 
        ...
        {
          title: "LEI Nº 4.645, DE 17 DE JANEIRO DE 2025",
          summary: `Estabelece princípios e diretrizes para a implementação e o uso 
